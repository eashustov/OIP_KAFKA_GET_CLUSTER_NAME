import {
  Virtualizer
} from "./chunk-JUQHYRUK.js";
import {
  VirtualKeyboardController
} from "./chunk-JFH4EKKA.js";
import {
  ComboBoxPlaceholder
} from "./chunk-EQ4OSAFA.js";
import {
  InputMixin
} from "./chunk-LF76XRAC.js";
import {
  PositionMixin
} from "./chunk-JZYF7JYD.js";
import {
  processTemplates
} from "./chunk-YMFKJ7HD.js";
import {
  item
} from "./chunk-L5DYYXT4.js";
import {
  menuOverlayCore
} from "./chunk-VPVZFIG3.js";
import {
  OverlayElement
} from "./chunk-ETGC4YJK.js";
import {
  overlay
} from "./chunk-K3GLQFPS.js";
import {
  isTouch
} from "./chunk-OZDFONM3.js";
import {
  ControllerMixin
} from "./chunk-SQBLVKGY.js";
import {
  KeyboardMixin
} from "./chunk-BKIWP6XF.js";
import {
  DisabledMixin
} from "./chunk-4NCM436X.js";
import {
  DirMixin
} from "./chunk-QISZI7VO.js";
import {
  ThemableMixin,
  registerStyles
...
var ComboBoxScroller = class extends PolymerElement {
  ...
  __updateElement(el, index) {
    ...
    el.setProperties({
      item: item2,
      index: this.__requestItemByIndex(item2, index),
  ...
  __requestItemByIndex(item2, index) {
    if (item2 instanceof ComboBoxPlaceholder && index !== void 0) {
      this.dispatchEvent(
...
var ComboBoxDropdown = class extends PolymerElement {
  ...
  ready() {
    ...
    this._scroller = overlay2.content.querySelector(scrollerTag);
    ...
    overlay2.addEventListener("touchend", (e) => this._fireTouchAction(e));
    overlay2.addEventListener("touchmove", (e) => this._fireTouchAction(e));
    overlay2.addEventListener("mousedown", (e) => e.preventDefault());
    overlay2.addEventListener("vaadin-overlay-outside-click", (e) => {
      e.preventDefault();
    });
  }
  ...
  getItemLabel(item2, itemLabelPath) {
    itemLabelPath = itemLabelPath || this._itemLabelPath;
    let label = item2 && itemLabelPath ? this.get(itemLabelPath, item2) : void 0;
...
var ComboBoxMixin = (subclass) => class VaadinComboBoxMixinElement extends ControllerMixin(KeyboardMixin(InputMixin(DisabledMixin(subclass)))) {
  ...
  _getItemLabel(item2) {
    return this.$.dropdown.getItemLabel(item2);
  }
  _getItemValue(item2) {
  ...
  _commitValue() {
    ...
    if (items && this._focusedIndex > -1) {
      ...
      const toLowerCase = (item2) => item2 && item2.toLowerCase && item2.toLowerCase();
      const itemMatchingByLabel = [...this.filteredItems || [], this.selectedItem].find((item2) => {
        return toLowerCase(this._getItemLabel(item2)) === toLowerCase(this._inputElementValue);
      });
  ...
  _valueChanged(value, oldVal) {
    ...
    if (this._isValidValue(value)) {
      ...
      if (!item2 && this.allowCustomValue) {
  ...
  _itemsOrPathsChanged(e) {
    if (e.path === "items" || e.path === "items.splices") {
      ...
      const item2 = valueIndex > -1 && this.items[valueIndex];
      if (item2) {
  ...
  _filteredItemsChanged(e) {
    if (e.path === "filteredItems" || e.path === "filteredItems.splices") {
      ...
      if (this._inputElementValue === void 0 || this._inputElementValue === this.value) {
 ...
 */
//# sourceMappingURL=chunk-L5YUJUWI.js.map
