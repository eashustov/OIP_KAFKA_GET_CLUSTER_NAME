...
// node_modules/@vaadin/flow-frontend/VaadinDevmodeGizmo.js
...
var VaadinDevmodeGizmo = class extends LitElement {
  constructor() {
    super(...arguments);
    this.expanded = false;
    this.messages = [];
  ...
  showNotification(type, message, details, link, persistentId) {
    if (persistentId === void 0 || !VaadinDevmodeGizmo.notificationDismissed(persistentId)) {
...
VaadinDevmodeGizmo.MAX_LOG_ROWS = 1e3;
...
VaadinDevmodeGizmo.AUTO_DEMOTE_NOTIFICATION_DELAY = 5e3;
...
if (customElements.get("vaadin-devmode-gizmo") === void 0) {
...
//# sourceMappingURL=@vaadin_flow-frontend_VaadinDevmodeGizmo_js.js.map
