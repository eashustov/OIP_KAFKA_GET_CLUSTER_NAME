import {
  ConnectionIndicator,
  ConnectionState
} from "./chunk-CYUQ3DYV.js";
import "./chunk-WJBGIX3A.js";
...
var Flow = class {
  ...
  async flowInit(serverSideRouting = false) {
    if (!this.isFlowClientLoaded()) {
      ...
      const bootstrapMod = await import("./FlowBootstrap-ICVXFWNX.js");
      await bootstrapMod.init(this.response);
      if (typeof this.config.imports === "function") {
        this.injectAppIdScript(appId);
        await this.config.imports();
      }
      const clientMod = await import("./FlowClient-N3ZNP3QT.js");
