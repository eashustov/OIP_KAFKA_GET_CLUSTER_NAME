...
import { _binderNode, _ItemModel, _key, _parent, _validators, AbstractModel, ArrayModel, getBinderNode, ObjectModel, } from './Models.js';
...
export class BinderNode {
    constructor(model) {
        ...
        Object.defineProperty(this, "defaultArrayItemValue", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    async validate() {
        ...
        const errors = (await Promise.all([...this.requestValidationOfDescendants(), ...this.requestValidationWithAncestors()]))
     ...
     */
    get errors() {
        const descendantsErrors = [...this.getChildBinderNodes()].reduce((errors, childBinderNode) => [...errors, ...childBinderNode.errors], []);
    ...
    *getChildBinderNodes() {
    ...
    initializeValue(requiredByChildNode = false) {
        ...
        if (value === undefined) {
            ...
            if (requiredByChildNode || !this.parent) {
                value = value !== undefined ? value : this.model.constructor.createEmptyValue();
...
_a = _visited, _b = _validators, _c = _ownErrors;
